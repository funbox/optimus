defmodule Optimus.HelpTest do
  ...
  test "arg column help" do
    help = Optimus.Help.formatable_help("ARGS:", optimus.args, 80)
  ...
  test "arg simple help" do
    help = Optimus.Help.formatable_help("ARGS:", optimus.args, 10)
    assert help == [
      "ARGS:",
      "",
  ...
  test "options column help" do
    help = Optimus.Help.formatable_help("OPTIONS:", optimus.options, 80)
  ...
  test "options simple help" do
    help = Optimus.Help.formatable_help("OPTIONS:", optimus.options, 10)
  ...
  test "flag column help" do
    help = Optimus.Help.formatable_help("FLAGS:", optimus.flags, 80)
  ...
  test "flag simple help" do
    help = Optimus.Help.formatable_help("FLAGS:", optimus.flags, 10)
